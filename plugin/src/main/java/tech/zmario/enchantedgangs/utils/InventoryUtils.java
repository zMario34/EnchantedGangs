...
public class InventoryUtils {
    ...
    public String toBase64(ItemStack[] items) throws IllegalStateException {
        try {
            ...
            throw new IllegalStateException("Error while serializing the inventory.", e);
        }
    }
    ...
    public Inventory fromBase64(String data, String inventoryName) throws IOException {
        try {
            ...
            Inventory inventory = Bukkit.getServer().createInventory(null, dataInput.readInt(), Utils.colorize(inventoryName));
